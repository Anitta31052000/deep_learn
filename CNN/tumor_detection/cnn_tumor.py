...
image_dir=r'D:\S3\stream_model\CNN\tumordata'
...
plt.savefig(r'D:\S3\stream_model\CNN\tumor_detection\results\tumor_sample_accuracy_plot.png')
...
plt.savefig(r'D:\S3\stream_model\CNN\tumor_detection\results\tumor_sample_loss_plot.png')
...
make_prediction(r'D:\S3\stream_model\CNN\tumordata\no\no5.jpg',model)
print("--------------------------------------\n")
make_prediction(r'D:\S3\stream_model\CNN\tumordata\yes\y4.jpg',model)
print("--------------------------------------\n")

#To save model
filename = r'D:\S3\stream_model\CNN\saved_cnn.pkl'
